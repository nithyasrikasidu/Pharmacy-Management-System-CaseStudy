...
namespace Pharmacy_Management_System.Controllers
{
    ...
    public class EmailProcessController : ControllerBase
    {
        ...
        public IActionResult EmailSending(List<Order> data_table)
        {
            ...
            textBody += "<br>";
            textBody += "<br><i>If you have any questions, contact us here on <b>nithyasrikasidu@gmail.com</b>! " +
                "We are here to help you! </i>";


            var message = new MimeMessage();
            message.From.Add(new MailboxAddress("Kasidu NithyaSri", "nithyasrikasidu@gmail.com"));
            ...
            using(var client = new SmtpClient())
            {
                ...
                client.Authenticate("nithyasrikasidu@gmail.com", "cmpfyvezmazlrrou");
                client.Send(message);
        ...
        public IActionResult EmailSendingToSupplier(string email)
        {
            ...
            {
                client.Connect("smtp.gmail.com", 587, false);
                client.Authenticate("nithyasrikasidu@gmail.com", "Nithya@2002");
                client.Send(message);
                client.Disconnect(true);
            }
